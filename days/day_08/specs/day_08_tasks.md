...
- [x] Create specs directory and specification files
    - [x] Create day_08_spec.md with detailed specification
    - [x] Create day_08_plan.md with technical plan
    - [x] Create day_08_tasks.md (this file)
...
- [x] Update README.md with solutions for Part 1 and Part 2
